...
Just a bit modify from Lucas' work. This now read image from the local file by using -n FILENAME and add the resize to let the model worked more stabilized.
